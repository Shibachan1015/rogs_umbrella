defmodule RogsIdentity.Accounts do
  @moduledoc """
  ...
  alias RogsIdentity.Accounts.{User, UserToken, UserNotifier}
  ...
  See `RogsIdentity.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `RogsIdentity.Accounts.User.password_changeset/3` for a list of supported options.
