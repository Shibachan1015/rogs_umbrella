defmodule RogsIdentityWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(RogsIdentityWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(RogsIdentityWeb.Gettext, "errors", msg, opts)
    # end
