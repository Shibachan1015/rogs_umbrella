...
#
#     PHX_SERVER=true bin/rogs_game start
#
...
if config_env() == :prod do
  ...
  config :rogs_game, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :rogs_game, RogsGame.Mailer,
...
# by passing the PHX_SERVER=true when you start it:
#
#     PHX_SERVER=true bin/shinkanki_web start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
...
if config_env() == :prod do
  ...
  config :shinkanki_web, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
...
# by passing the PHX_SERVER=true when you start it:
#
#     PHX_SERVER=true bin/shinkanki start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
...
if config_env() == :prod do
  ...
  config :shinkanki, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
...
# by passing the PHX_SERVER=true when you start it:
#
#     PHX_SERVER=true bin/rogs_comm start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
...
if config_env() == :prod do
  ...
  config :rogs_comm, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
...
# by passing the PHX_SERVER=true when you start it:
#
#     PHX_SERVER=true bin/rogs_identity start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
...
if config_env() == :prod do
  ...
  config :rogs_identity, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
...
if config_env() == :prod do
  ...
  #
  #     config :rogs_web, RogsWeb.Endpoint, server: true
  #
