          ...
          <article class="game-card migaki-card">
            <%= if @editing_card == card.id do %>
              <.form for={@changeset} phx-submit="save_edit" class="card-edit-form">
                ...
                <div class="card-form-field">
                  <label>画像URL</label>
                  <input type="url" name="migaki_card[image_url]" value={@changeset.data.image_url} placeholder="https://example.com/image.jpg" />
                </div>
      ...
      <%= if @show_new_form do %>
        <section class="new-card-form-section">
          ...
          <.form for={@changeset} phx-submit="create_card" class="card-edit-form">
            ...
            <div class="card-form-field">
              <label>画像URL</label>
              <input type="url" name="migaki_card[image_url]" placeholder="https://example.com/image.jpg" />
            </div>
            <div class="card-form-actions">
