...
config :rogs_game, RogsGame.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "rogs_game_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :rogs_game, RogsGameWeb.Endpoint,
  ...
  secret_key_base: "hVzT7cyExMSImPE5HkbBcQiuf0s1J7QdEAwCFFPYN4/rjuDUji3t2aFqFhoil89c",
  server: false

# In test we don't send emails
config :rogs_game, RogsGame.Mailer, adapter: Swoosh.Adapters.Test
