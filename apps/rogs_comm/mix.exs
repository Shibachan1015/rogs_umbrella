defmodule RogsComm.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind rogs_comm", "esbuild rogs_comm"],
      "assets.deploy": [
        "tailwind rogs_comm --minify",
        "esbuild rogs_comm --minify",
        "phx.digest"
      ],
